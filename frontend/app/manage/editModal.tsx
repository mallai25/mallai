            ...
            <DialogHeader className="mb-6">
              ...
              <DialogDescription>
                {canEdit
                  ...
                  : "View product details. You must be logged in and be the original uploader to make changes."}
              </DialogDescription>
              {!canEdit && (
                <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg text-amber-800 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span>You are in view-only mode. Please log in and be the original uploader to make changes.</span>
                  </div>
                </div>
              )}
            </DialogHeader>
                            ...
                            <div>
                              ...
                              <div className="relative flex items-center">
                                <Input
                                  ...
                                  className="pl-10 rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 h-12 text-base"
                                  disabled={!canEdit || !weightEditMode}
                                />
                                <Package className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="mt-6">
                      ...
                      <div className="mt-4">
                        ...
                        {editedInfluencer.socialAccounts.length > 0 ? (
                          <div className="space-y-3">
