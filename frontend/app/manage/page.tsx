...
export default function ManagePage() {
  ...
  const saveProduct = async () => {
    ...
    if (
      (newInfluencer.name || newInfluencer.image || newInfluencer.bio) &&
      (!newInfluencer.name || !newInfluencer.image || newInfluencer.bio)
    ) {
      toast({
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) => user && setNewProduct({ ...newProduct, category: value })}
                            disabled={!user}
                          >
                            <SelectTrigger
                              id="product-category"
                          ...
                          <div>
                            ...
                            <div className="mt-1 relative">
                              <Input
                                ...
                                onChange={(e) => user && setNewProduct({ ...newProduct, price: e.target.value })}
                                className="pl-10 rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 h-12 text-base"
                                disabled={!user}
                              />
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  <Input
                                    ...
                                    onChange={(e) =>
                                      user && setNewSimilarProduct({ ...newSimilarProduct, weight: e.target.value })
                                    }
                                    className="pl-10 rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 h-12 text-base"
                                    disabled={!user}
                                  />
                                ...
                                {newInfluencer.image ? (
                                  <>
                                    ...
                                    <button
                                      ...
                                      className="absolute -top-2 -right-2 h-8 w-8 rounded-full bg-black/70 hover:bg-black/90 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none inline-flex items-center justify-center shadow-md"
                                      disabled={!user}
                                    >
                              ...
                              {newInfluencer.socialAccounts.map((account, index) => (
                                ...
                                >
                                  ...
                                  <Button
                                    ...
                                    size="sm"
                                    className="h-8 w-8 p-0 rounded-full text-red-500 hover:text-red-700 hover:bg-red-50"
                                    onClick={() => user && removeSocialAccount(index)}
                                    disabled={!user}
                                  >
                                    <Trash2 className="h-4 w-4" />
                                  </Button>
