...
import { ChevronRight, Gift, User, ArrowRight, Package, BarChart, QrCode, PodcastIcon } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-white mt-2 overflow-hidden">
        ...
        <div className="hidden md:block absolute -top-20 -left-20 w-40 h-40 bg-blue-300 rounded-full opacity-5 animate-pulse"></div>
          <div
