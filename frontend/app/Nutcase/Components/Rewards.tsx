...
import NinjaSkins from './Thumbnails/NinjaSkins.jpeg'
import FortniteEvent from './Thumbnails/BattleRoyal.jpg'
...
export function Rewards() {
  ...
  const steps = [
    {
      number: 1,
      title: "Buy Nutcase Milk",
      description: "Purchase Nutcase from our website or any store"
    },
    {
      number: 2,
    ...
    },
    {
      number: 4,
      title: "Win Prizes",
      description: "Top participants will recieve Prizes from Nutcase"
    }
  ];

  const prizes = [
    {
      title: "Win Ninja's Fortnite Skins ",
      description: "Get limited Edition Fornite Skins!",
      image: NinjaSkins
    },
    {
      title: "Passes to Fortnite Battle Royale Esports!",
      description: "Win passes to attend Fortnite Esports Event",
      image: FortniteEvent
    },
  ]
