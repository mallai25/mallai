                ...
                {rewardsCampaigns.length > 0 ? (
                  <div className="space-y-4">
                    {rewardsCampaigns.map((campaign) => (
                      <div 
                        key={campaign.id} 
                        className="bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow p-4"
                      >
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <div className={`px-3 py-1 rounded-full text-xs font-medium ${
                            ...
                            {campaign.status === 'active' ? 'Active' : 'New'}
                          </div>
                        </div>
                        ...
                        <div className="mb-3">
                          <div className="flex justify-between text-sm mb-1">
                            <span>Progress</span>
                            <span className="font-medium">{campaign.uploadedReceipts}/{campaign.totalRequired} Uploads</span>
                          </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-gray-700 font-medium mb-1">No rewards campaigns yet</h3>
                    <p className="text-sm text-gray-500 mb-4">Start participating in rewards campaigns to see them here</p>
                ...
                <div className="flex space-x-4 p-1">
                  {['All', 'Beverage', 'Coffee', 'Candy', 'Personal Care', 'Alcohol', 'Supplements'].map((category) => (
                    <Button
                      ...
                      className={`rounded-full px-4 py-2 text-sm bg-blue-600`}
                    >
                      {category}
                    </Button>
                  ))}
