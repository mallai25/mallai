...
export function ProductQA({ onBack }) {
  ...
  const qaItems = [
    {
      question: "AI-Generated Product Information",
      answer: "Our AI will analyze and generate detailed information about this product based on your specific queries and interests."
    },
    {
      question: "Digital Sources",
      answer: "Here you'll find comprehensive product details gathered from the official website and various trusted digital sources."
    },
  ];
