...
const RewardThen: RewardWinner[] = [
  {
    ...
    purchaseHistory: [
      { product: "Premium Coffee Blend", date: "2024-02-07 14:30" },
      { product: "Organic Tea Selection", date: "2024-02-06 11:20" },
      { product: "Specialty Roast Bundle", date: "2024-02-05 09:45" }
    ],
    receipts: [
      { id: "r1", image: "https://example.com/receipt1.jpg", date: "2024-02-07", amount: "$45.99" },
      { id: "r2", image: "https://example.com/receipt2.jpg", date: "2024-02-06", amount: "$32.50" },
      { id: "r3", image: "https://example.com/receipt3.jpg", date: "2024-02-05", amount: "$28.75" }
    ]
  },
  {
    id: "2",
    ...
    purchaseHistory: [
      { product: "Signature Espresso Pack", date: "2024-02-06 16:15" },
      { product: "Coffee Maker Deluxe", date: "2024-02-05 13:40" }
    ],
    receipts: [
      { id: "r4", image: "https://example.com/receipt4.jpg", date: "2024-02-06", amount: "$55.99" },
      { id: "r5", image: "https://example.com/receipt5.jpg", date: "2024-02-05", amount: "$129.99" }
    ]
  },
  {
    id: "3",
    ...
    purchaseHistory: [
      { product: "Morning Brew Collection", date: "2024-02-05 10:25" }
    ],
    receipts: [
      { id: "r6", image: "https://example.com/receipt6.jpg", date: "2024-02-05", amount: "$42.99" }
    ]
  }
]
...
export function AnalyticsTab({ userProducts }: AnalyticsTabProps) {
        ...
        <ScrollArea className="h-[90vh] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] p-4 rounded-md">
          <div className="mt-5 p-0 sm:p-1">
                ...
                <div className="mt-4 sm:ml-16 sm:mt-0">
                  <div className="bg-indigo-50 p-3 sm:p-3 rounded-full flex justify-between items-center border border-indigo-100">
                    ...
                    <div className="inline-flex items-center justify-center bg-indigo-100 rounded-full w-8 h-8">
                      <p className="text-md sm:text-md font-bold text-indigo-700">{userProducts.length}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {userProducts.length === 0 ? (
              ...
              <div className="space-y-3">
                {userProducts.map((listing) => (
                  <Card key={listing.id} className="border border-gray-100 min-h-96 rounded-3xl px-4 py-2 mb-2 w-full">
                    <div className="relative space-y-2">
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 pl-2">
                        <h4 className="text-lg font-semibold">{listing.category}</h4>                          
                    ...
                    <div className="p-2 mt-2 relative min-h-44">
                      ...
                      >
                        {listing.similarProducts && listing.similarProducts.map((item) => (
                            ...
                            <div className="border border-gray-100 rounded-xl p-3 hover:border-blue-200 transition-colors group/card">
                              <div className="relative aspect-square rounded-lg overflow-hidden cursor-pointer">
                                ...
                                <Image
                                  ...
                                  layout="fill"
                                  objectFit="cover"
                                  className="transform scale-75 group-hover/card:scale-90 transition-transform duration-300 ease-in-out"
                                />
  ...
  const renderActiveProductsCard = () => (
    <Card className="bg-gradient-to-br from-indigo-500 to-purple-600 text-white shadow-xl">
      ...
      <CardContent>
        <div className="text-xl sm:text-2xl font-bold">{userProducts.length}</div>
      ...
      {editingStore?.id === store.id ? (
        <div className="space-y-4">
          ...
          <Select 
            ...
            onValueChange={(value) => setEditingStore({...editingStore, type: value})}
          >
            <SelectTrigger>
          ...
          <div className="flex justify-between gap-4">
            <Button variant="outline" className="rounded-full" onClick={() => setEditingStore(null)}>Cancel</Button>
            <Button className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-full" 
            onClick={() => handleEditStore(editingStore)}>Save</Button>
          </div>
        </div>
      ) : (
  ...
  return (
    <div className="flex-1 p-0 sm:p-1 space-y-4 sm:space-y-4 bg-gray-50">
              ...
              <div className="p-0 sm:p-1">
                ...
                <div className="flex justify-end gap-3 sm:gap-4 mb-8">
                  <div className="bg-cyan-50 p-3 sm:p-4 rounded-2xl">
                    <div className="flex items-center gap-2">
                      <p className="text-xl sm:text-2xl font-bold text-cyan-700">{allSubmissions}</p>
                  ...
                  <div className="bg-rose-50 p-3 sm:p-4 rounded-2xl">
                    <div className="flex items-center gap-2">
                      <p className="text-xl sm:text-2xl font-bold text-rose-700">{todaySubmissions}</p>
                ...
                <Card className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 mt-4">
                  {/* Active Rewards Section */}
                    ...
                    <div className="flex justify-between items-center mb-4">
                      ...
                      >
                        {isPreviewMode ? "View Live" : "Preview"}
                      </Button>
                    </div>
                    <div className="space-y-4">
                      {(isPreviewMode ? RewardThen : rewardWinners).map((winner, index) => (
...
<DialogContent className="w-[95vw] max-w-[1000px] p-2 rounded-lg ">
{selectedParticipant && (
                    ...
                    <div className="space-y-8 w-3/6">
                        ...
                        <Card className="bg-white p-4 flex flex-col">
                          ...
                          <div className="relative">
                            ...
                            {(isPreviewMode ? RewardThen : rewardWinners).find(p => p.id === selectedParticipant.id)?.purchaseHistory?.map((purchase, i) => (
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="bg-yellow-100 text-yellow-700 text-xs px-2 py-0.5 rounded-full">
                          {(isPreviewMode ? RewardThen : rewardWinners).find(p => p.id === selectedParticipant.id)?.stamps?.filter(s => s.stamped).length}/6 Stamps
                        </div>
                      </div>
                      <div className="space-y-2">
                        <div className="grid grid-cols-6 gap-1">
                          {(isPreviewMode ? RewardThen : rewardWinners).find(p => p.id === selectedParticipant.id)?.stamps?.map((stamp, i) => (
      ...
      <Card className="flex-1 shadow-xl overflow-hidden">
        ...
        <Card className="flex-1 shadow-xl overflow-hidden mt-6">
        <CardHeader>
          <div className="flex items-center space-x-2">
