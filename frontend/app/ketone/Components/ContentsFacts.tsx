  ...
  return (
    <>
      ...
      <Dialog open={showContentModal} onOpenChange={setShowContentModal}>
        <DialogContent className="sm:max-w-2xl max-h-[90vh] flex flex-col overflow-y-auto pr-8 -mr-4 
        space-y-2 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-200 [&::-webkit-scrollbar-track]:bg-gray-100 hover:[&::-webkit-scrollbar-thumb]:bg-gray-300 transition-colors">
          ...
          <div className="mt-6 flex-1">
            <div className="space-y-3">
              {[
                ...
                >
                  <p className="text-sm text-gray-700 font-medium">{ingredient}</p>
                </div>
              ))}
          ...
          <div className="w-full mt-4">
                <p className="text-sm text-gray-700 font-medium">NB: NON GMO, No Sugar, Vitamin B6, Vitamin B12, Vegan, No Artificial Colors, No Salt, No Gluten</p>
              </div>
