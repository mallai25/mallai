...
export function ConnectMedia({ logoOnly = false }) {
...
// },
{
  ...
  url: "https://twitter.com/ketoneiq",
},
    {
      ...
      url: "https://instagram.com/ketoneiq",
    },
    {
      ...
      url: "https://youtube.com/@ketone-iq",
    },
    {
      name: "Instagram Profile",
      icon: Instagram,
      ...
      hoverBg: "hover:bg-[#E4405F]/90",
      lightBg: "hover:bg-[#E4405F]/10",
      url: "https://instagram.com/michaeldbrandt",
    },
    {
      name: "Instagram Profile",
      icon: Instagram,
      ...
      hoverBg: "hover:bg-[#E4405F]/90",
      lightBg: "hover:bg-[#E4405F]/10",
      url: "https://instagram.com/geoffreywoo",
    },
    {
      name: "Twitter Profile",
      icon: Twitter,
      ...
      hoverBg: "hover:bg-[#1DA1F2]/90",
      lightBg: "hover:bg-[#1DA1F2]/10",
      url: "https://twitter.com/geoffreywoo",
    },
  ]
            ...
            <Card className={`overflow-hidden group transition-all duration-200 hover:shadow-sm 
              ...
              <CardContent className={`p-4 flex flex-col items-center justify-center h-full ${logoOnly ? '' : ''}`}>
                <div className={`flex flex-col items-center space-y-2 ${logoOnly ? '' : 'gap-2 p-2 rounded-lg'}`}>
                  <account.icon className={`w-8 h-8 ${account.color} group-hover:scale-110 transition-transform duration-200
                    ${logoOnly ? 'w-32 h-32' : ''}`} />
