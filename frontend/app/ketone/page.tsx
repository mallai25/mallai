...
import KetonePeach from './Images/peach.png';
import KetoneApple from './Images/apple.png';
import KetoneRasberry from './Images/rassbery.png';

import KetoneCaffine from './Images/peachCaffine.png';
import KetoneCaffineApple from './Images/applecaffine.png';
import KetoneCaffineRasberry from './Images/rassberrycaffine.png';
...
function ProductContent() {
  ...
  const products = [
    ...
    {
      id: 3,
      name: "Raspberry Caffeine Shot",
      category: "Supplement",
      description: "Ideal for focused minds and active bodies, shots deliver a sugar-free boost",
      imageSrc: KetoneRasberry,
      gtin: "n/a",
      brand: "Ketone-IQ", 
      weight: "2 fl oz (59 ml)",
    },
    ...
    {
      id: 5,
      name: "No Caffeine Apple",
      category: "Supplement",
      description: 'One daily shot will help you feel clear, focused, and ready to take on any challenge',
      imageSrc: KetoneCaffineApple,
      gtin: "n/a",
      brand: "Ketone-IQ", 
      weight: "2 fl oz (59 ml)",
    },
    {
      id: 6,
      name: "No Caffeine Rasberry",
      category: "Supplement",
      description: 'One daily shot will help you feel clear, focused, and ready to take on any challenge',
      imageSrc: KetoneCaffineRasberry,
      gtin: "n/a",
      brand: "Ketone-IQ", 
      weight: "2 fl oz (59 ml)",
    },
