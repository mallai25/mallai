...
export function Rewards({selectedProduct, campaigns}) {

  const stamps = [
    { date: "06/01", stamped: false },
    { date: "06/15", stamped: false },
  ...
  const steps = [
    {
      ...
      description: "Purchase an item from any store"
    },
    {
      number: 2,
    ...
    },
    {
      number: 4,
      title: "Win Prizes",
      description: "Top participants will recieve Prizes!"
    }
  ];
  ...
  return (
    <div className="space-y-4 sm:space-y-8 bg-gradient-to-b from-white to-yellow-50/30 min-h-screen pb-6 sm:pb-6">
      {/* Hero Section */}
      <div className="relative w-full h-[180px] sm:h-[250px] md:h-[250px] rounded-3xl mb-6 overflow-hidden">
        ...
        <div className="relative z-20 h-full flex items-center justify-center">
          <div className="text-center space-y-2 sm:space-y-4 px-4 max-w-[90%] sm:max-w-2xl mx-auto">
            <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
              Win Big with {selectedProduct.brand}
            </h1>
          </div>
        </div>
      </div>
          ...
          <div key={index} className="w-full md:w-1/2 px-4 mb-8">
            <div className="group">
              <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-4 z-20">
                  ...
                  <h3 className="text-base sm:text-xl font-bold text-white mb-0.5 sm:mb-1">{prize.name}</h3>
      ...
      <Dialog open={showParticipantDialog} onOpenChange={setShowParticipantDialog}>
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter your information to complete your participation in this rewards campaign.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter className="flex flex-col-reverse sm:flex-row gap-3">
            ...
            <Link href="/join" className="w-full sm:w-auto order-1 sm:order-2">
              <Button className="w-full bg-blue-600 hover:bg-blue-700 rounded-xl py-2.5">
