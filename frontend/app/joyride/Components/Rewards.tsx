...
import JoyPack from './Thumbnails/JoyPack.jpg'
import RyanAir from './Thumbnails/RyanAir.jpeg'
...
export function Rewards() {
  ...
  const steps = [
    {
      number: 1,
      title: "Buy JoyRide Candy",
      description: "Purchase JoyRide from Target"
    },
    {
      number: 2,
    ...
    },
    {
      number: 4,
      title: "Get Featured",
      description: "Top participants will be featured in Ryan's vlogs!"
    }
  ];

  const prizes = [
    {
      title: "Win a Box of JoyRide Candy",
      description: "Get a pack of JoyRide Candy!",
      image: JoyPack
    },
    {
      title: "Be in a Ryan Trahan Vlog!",
      description: "Top participants will be featured",
      image: RyanAir
    },
  ]
