...
export function ConnectMedia({ logoOnly = false }) {
  const socialAccounts = [

    {
      ...
      url: "https://twitter.com/jakepaul",
    },
    // {
    //   name: "LinkedIn Page",
    //   icon: Linkedin,
    ...
    // },
    {
      ...
      url: "https://instagram.com/itscalledw",
    },
    {
      name: "TikTok Profile",
      icon: TikTok,
      ...
      url: "https://tiktok.com/@itscalledw",
    },
    {
      ...
      url: "https://youtube.com/@jakepaul",
    },
    {
      name: "Instagram Profile",
      icon: Instagram,
      ...
      hoverBg: "hover:bg-[#E4405F]/90",
      lightBg: "hover:bg-[#E4405F]/10",
      url: "https://instagram.com/jakepaul",
    },
  ]
