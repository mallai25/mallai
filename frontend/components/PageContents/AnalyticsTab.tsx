...
import ImageJoyBack from './images/rfront.png';
          ...
          <div className="mt-5 p-0 sm:p-1">
            ...
            <div className="space-y-4">
                  ...
                  <div className="bg-white rounded-xl overflow-hidden">
                    ...
                    <div className="border border-gray-100 rounded-2xl px-4 py-2 mb-2 w-full">
                        {/* Product Info */}
                        <div className="flex-1">
                          <div className="relative space-y-2">
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 pl-2">
                              <h4 className="text-lg font-semibold">JoyRide Candy Strips</h4>                          
                        ...
                        <div className="p-2 mt-2 relative">
                          ...
                          <div className="flex-none w-[80%] sm:w-1/3 snap-center first:ml-2 sm:first:ml-0">
                              <div className="border border-gray-100 rounded-xl p-3 hover:border-blue-200 transition-colors group/card">
                                ...
                                <div className="space-y-1">
                                  ...
                                  <p className="text-xs text-gray-600">A punch of sour, a burst of berry</p>
                                  <div className="flex justify-end mt-3">
                                    <Button
                                      variant="ghost"
                                      size="sm"
                                      className="h-8 w-8 rounded-lg bg-gradient-to-br from-red-400 to-red-500 p-0 hover:shadow-lg shadow-md border-2 border-white transition-all group"
                                    >
                            ...
                            {/* Blue */}
                            <div className="flex-none w-[80%] sm:w-1/3 snap-center">
                              <div className="border border-gray-100 rounded-xl p-3 hover:border-blue-200 transition-colors group/card">
                                <div className="relative aspect-square rounded-lg overflow-hidden cursor-pointer">
                                  <div className="absolute inset-0 duration-300 z-10"></div>
                                  <Image
                                ...
                                <div className="space-y-1">
                                  <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
                                    <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-700">
                                      Blue Raspberry Strips
                                    </span>
                                  </div>
                                  <p className="text-xs text-gray-600">Sweet and tangy blue raspberry flavor</p>
                                  <div className="flex justify-end mt-3">
                                    <Button
                                      variant="ghost"
                                      size="sm"
                            ...
                            {/* Green Apple */}                          
                              <div className="flex-none w-[80%] sm:w-1/3 snap-center">
                              <div className="border border-gray-100 rounded-xl p-3 hover:border-green-200 transition-colors group/card">
                                <div className="relative aspect-square rounded-lg overflow-hidden cursor-pointer">
                                  <div className="absolute inset-0 duration-300 z-10"></div>
                                  <Image
                                  src={GreenImage}
                                ...
                                <div className="space-y-1">
                                  <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
                                    <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-700">
                                      Green Apple Strips                              </span>
                                    
                                  </div>
                                  <p className="text-xs text-gray-600">Crisp and tart green apple taste</p>
                                  <div className="flex justify-end mt-3">
                                    <Button
                                      variant="ghost"
                                      size="sm"
                                      className="h-8 w-8 rounded-lg bg-gradient-to-br from-green-400 to-green-500 p-0 hover:shadow-lg shadow-md border-2 border-white transition-all group"
                                    >
                                      <QrCode className="h-4 w-4 text-white group-hover:scale-110 transition-transform" />
                                    </Button>
                                  </div>
                            ...
                            {/* Lemon */}
                            <div className="flex-none w-[80%] sm:w-1/3 snap-center">
                              <div className="border border-gray-100 rounded-xl p-3 hover:border-yellow-200 transition-colors group/card">
                                <div className="relative aspect-square rounded-lg overflow-hidden cursor-pointer">
                                  <div className="absolute inset-0 duration-300 z-10"></div>
                                  <Image
                                  src={YellowImage}
                                ...
                                <div className="space-y-1">
                                  ...
                                  <p className="text-xs text-gray-600">Zesty and refreshing citrus flavor</p>
                                  <div className="flex justify-end mt-3">
                                    <Button
                                      variant="ghost"
                                      size="sm"
                                      className="h-8 w-8 rounded-lg bg-gradient-to-br from-yellow-400 to-yellow-500 p-0 hover:shadow-lg shadow-md border-2 border-white transition-all group"
                                    >
                                      <QrCode className="h-4 w-4 text-white group-hover:scale-110 transition-transform" />
                                    </Button>
                                  </div>
                          ...
                          <button 
                            className="absolute -left-1 top-1/2 -translate-y-1/2 z-50 p-3 rounded-full bg-white shadow-xl hover:bg-gray-50 transition-all border border-gray-100 hidden sm:flex items-center justify-center hover:scale-110"
                            onClick={() => {
                              const container = document.getElementById('product-deodorant');
                              if (container) container.scrollLeft -= container.offsetWidth / 2;
                            }}
                          >
                            <ChevronLeft className="w-5 h-5 text-gray-700" />
