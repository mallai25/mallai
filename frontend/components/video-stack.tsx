...
import Gordon from './Thumbnails/Gordan.jpg'
import Introduce from './Thumbnails/Introduce.jpg'
import JoyRide from './Thumbnails/JoyDay.jpg'
...
const videos = [
  ...
  {
    id: "_Mtb5qcZrlE",
    title: "Gordan Ramsey Tries JOYRIDE",
